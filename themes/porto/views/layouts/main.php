...
<html>
	<head>
		...
		<title>Porto - Responsive HTML5 Template 5.7.1</title>	
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="<?php echo $this->theme->baseUrl; ?>img/favicon.ico" type="image/x-icon" />
		<link rel="apple-touch-icon" href="<?php echo $this->theme->baseUrl; ?>img/apple-touch-icon.png">
		...
		<!-- Vendor CSS -->
		<link rel="stylesheet" href="<?php echo $this->theme->baseUrl; ?>vendor/bootstrap/css/bootstrap.min.css">
		<link rel="stylesheet" href="<?php echo $this->theme->baseUrl; ?>vendor/font-awesome/css/font-awesome.min.css">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 500}">
						<ul>
							<li data-transition="fade">
								<img src="img/slides/slide-bg-light.jpg"  
									alt=""
								...
								<div class="tp-caption"
									 ...
									 data-y="0"
									 data-start="2600"
									 data-transform_in="z:0;rX:0;rY:0;rZ:0;sX:0.9;sY:0.9;skX:0;skY:0;opacity:0;s:500;e:Power2.easeOut;"><img src="img/slides/slide-light-2.png" alt=""></div>

								<div class="tp-caption"
									 data-x="630"
									 data-y="bottom"
									 data-start="2100"
									 data-transform_in="z:0;rX:0;rY:0;rZ:0;sX:0.9;sY:0.9;skX:0;skY:0;opacity:0;s:500;e:Power2.easeOut;"><img src="img/slides/slide-light-1.png" alt=""></div>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-6 mt-lg">
								<img class="img-responsive appear-animation" src="img/device.png" data-appear-animation="fadeInRight" alt="">
							</div>
						</div>
					</div>
				</section>
